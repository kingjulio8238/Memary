...
def benchmark(model_name: str, data_points: List, conciseness: List, informativeness: List, accuracy: List):
    load_dotenv()
    pplx_api_key = os.getenv("PERPLEXITY_API_KEY")

    query_llm = Perplexity(
        api_key=pplx_api_key, model=model_name, temperature=0.5
    )
